...
<jsp:include page="../mail/mailMenu.jsp"></jsp:include>
	<form action="/mail/mailRegister.sw" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="mailSender" value="${loginUser.mail }">
			...
			<br>
			<div>
				<div><strong id="write">제목 </strong>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;<input type="text" size="130" style= "height: 30px" name="mailSubject" value="FW: ${mail.mailSubject }"></div>
			</div>
			<br>
			<br>
			<div>
			...
			<br>
				...
				<textarea rows="25" cols="160" name="mailContent" id="mailContent">
