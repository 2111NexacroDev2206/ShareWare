...
<body>
	...
	<div class="s-menu">
		...
		<div class="s-list-item ${listCondition eq 'dailyWrite' ? 'active' : ''}"><a href="">일일 업무일지 작성</a></div>
		<div class="s-list-item ${listCondition eq 'approval' ? 'active' : ''}"><a href="">주간 업무일지 작성</a></div>
		<div class="s-list-item ${listCondition eq 'dailyList' ? 'active' : ''}"><a href="">일일 업무현황</a></div>
