            ...
            "Form" :
            				...
            				[
            					{
            						"btn_meetingRoom" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("2px solid rgb(187,156,202)"),
            									"color" : nexacro.ColorObject("#a5a5a5"),
            									"font" : nexacro.FontObject("normal bold  18pt/normal \"Arial\"")
            								},
            								"selected" :
            								{
            									"border" : nexacro.BorderObject("1px solid rgb(187,156,202)"),
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("normal 18pt /normal \"Arial\"")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("2px solid rgb(187,156,202)"),
            				...
            				[
            					{
            						"noticeEdit" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #7f7f7f"),
            									"padding" : nexacro.PaddingObject("3px 5px 3px 10px"),
            									"font" : nexacro.FontObject("normal 15pt /normal \"Arial\"")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #bb9cca")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("1px solid #bb9cca")
            			...
            			"Grid" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"border" : nexacro.BorderObject("1px solid rgb(204, 204, 204), 1px none rgb(51, 51, 51), 1px solid rgb(204, 204, 204), 1px none #ccc")
            					}
            				}
            			},
            			"cell" :
            									...
            									"Grid" :
            									{
            										"self" :
            										{
            											"enabled" :
            											{
            												...
            												"border" : nexacro.BorderObject("1px solid rgb(204, 204, 204), 1px none rgb(51, 51, 51), 1px solid rgb(204, 204, 204), 1px none rgb(51, 51, 51)"),
